...
from calibration import before_calibration_start, now_sec
...
parser.add_argument("--burn-in", type=float, default=350)
...
if __name__ == "__main__":
    ...
    for match in MATCHES:
        ...
        home_advantage = 0 if match.get("neutral") else HOME_ADVANTAGE
        update_home_advantage = 0 if match.get("neutral") else UPDATE_HOME_ADV
        ...
        delta = rating_update(
            ...
            home_advantage=update_home_advantage, use_recency=False
        )
    ...
    print(f"→ wrote {BACKTEST_REPORT_FILE}")
